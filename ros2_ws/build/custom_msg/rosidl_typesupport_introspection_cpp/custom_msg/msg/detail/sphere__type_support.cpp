...
{
  new (message_memory) custom_msg::msg::Sphere(_init);
}

void Sphere_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msg::msg::Sphere *>(message_memory);
...
{
  return &::custom_msg::msg::rosidl_typesupport_introspection_cpp::Sphere_message_type_support_handle;
}
