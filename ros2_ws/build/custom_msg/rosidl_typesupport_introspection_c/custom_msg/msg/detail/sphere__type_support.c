...
#include <stddef.h>
#include "custom_msg/msg/detail/sphere__rosidl_typesupport_introspection_c.h"
...
void custom_msg__msg__Sphere__rosidl_typesupport_introspection_c__Sphere_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  custom_msg__msg__Sphere__init(message_memory);
}

void custom_msg__msg__Sphere__rosidl_typesupport_introspection_c__Sphere_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers custom_msg__msg__Sphere__rosidl_typesupport_introspection_c__Sphere_message_members = {
  ...
  custom_msg__msg__Sphere__rosidl_typesupport_introspection_c__Sphere_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t custom_msg__msg__Sphere__rosidl_typesupport_introspection_c__Sphere_message_type_support_handle = {
  0,
  &custom_msg__msg__Sphere__rosidl_typesupport_introspection_c__Sphere_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_msg, msg, Sphere)() {
  ...
  return &custom_msg__msg__Sphere__rosidl_typesupport_introspection_c__Sphere_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
