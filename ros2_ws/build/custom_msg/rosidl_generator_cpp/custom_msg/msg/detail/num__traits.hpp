...
#ifndef CUSTOM_MSG__MSG__DETAIL__NUM__TRAITS_HPP_
#define CUSTOM_MSG__MSG__DETAIL__NUM__TRAITS_HPP_
...
inline std::string to_yaml(const custom_msg::msg::Num & msg)
{
...
template<>
inline const char * name<custom_msg::msg::Num>()
{
  return "custom_msg/msg/Num";
}
...
template<>
struct is_message<custom_msg::msg::Num>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // CUSTOM_MSG__MSG__DETAIL__NUM__TRAITS_HPP_
